...
const createChannelEndpoint = `${serverAddress}/createChannel/`
const queryChannelEndpoint = `${serverAddress}/getServerChannels/`
const joinServerEndpoint = `${serverAddress}/joinServer/`
